...
def get_siamese_model(training=True):
    ...
    embedding_p3 = tf.keras.Sequential([layers.Conv2D(EMBEDDING_LAYER_DIM*2, (2, 2)), layers.BatchNormalization(), layers.Activation("relu"), layers.Conv2D(EMBEDDING_LAYER_DIM, (1, 1)), layers.BatchNormalization(), layers.Activation("relu"), layers.GlobalAveragePooling2D()])
    embedding_p4 = tf.keras.Sequential([layers.Conv2D(EMBEDDING_LAYER_DIM*2, (2, 2)), layers.BatchNormalization(), layers.Activation("relu"), layers.Conv2D(EMBEDDING_LAYER_DIM, (1, 1)), layers.BatchNormalization(), layers.Activation("relu"), layers.GlobalAveragePooling2D()])
    embedding_p5 = tf.keras.Sequential([layers.Conv2D(EMBEDDING_LAYER_DIM*2, (2, 2)), layers.BatchNormalization(), layers.Activation("relu"), layers.Conv2D(EMBEDDING_LAYER_DIM, (1, 1)), layers.BatchNormalization(), layers.Activation("relu"), layers.GlobalAveragePooling2D()])
    embedding_p2 = tf.keras.Sequential([layers.Conv2D(EMBEDDING_LAYER_DIM*2, (2, 2)), layers.BatchNormalization(), layers.Activation("relu"), layers.Conv2D(EMBEDDING_LAYER_DIM, (1, 1)), layers.BatchNormalization(), layers.Activation("relu"), layers.GlobalAveragePooling2D()])
    embedding_p6 = tf.keras.Sequential([layers.Conv2D(EMBEDDING_LAYER_DIM*2, (2, 2)), layers.BatchNormalization(), layers.Activation("relu"), layers.Conv2D(EMBEDDING_LAYER_DIM, (1, 1)), layers.BatchNormalization(), layers.Activation("relu"), layers.GlobalAveragePooling2D()])
